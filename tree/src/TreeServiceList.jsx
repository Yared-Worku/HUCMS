    ...
    return (
      ...
      >
        <div style={{ padding: '20px' }}>
          ...
          <div 
            onClick={() => {
              // Trigger modal ONLY when clicking a service and user has no department
              if (!isExpanded && departments !== null && departments.length === 0) {
                setShowCampusModal(true);
              }
              setVisibleDept(isExpanded ? null : svc.service_code);
            }}
